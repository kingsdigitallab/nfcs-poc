...
const PREVIEW_CSS = [
  ...
  'h1,h2,h3,h4,h5,h6{color:#2c2a24;margin-top:1.2em;margin-bottom:.3em;font-weight:600}',
  ...
  'td,th{border:1px solid #ece3d0;padding:4px 8px;text-align:left}',
  'th{background:#faf6ec;font-weight:600}',
...
const CAPTURE_SCRIPT = [
  ...
  '    ph.style.cssText="border:1px dashed #d6ccb5;border-radius:4px;padding:10px;font-size:11px;color:#b0a891;text-align:center;margin:8px 0;background:#fafafa";',
